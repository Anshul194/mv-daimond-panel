...
const navItems: NavItem[] = [
    ...
    subItems: [
      ...
      },
      {
        ...
        subItems: [
          {
            name: "Size List",
            path: "/attributes/size-charts/list",
            pro: false,
          },
      ...
      },
      {
        ...
        path: "/attributes/colors",
        subItems: [
          { name: "Brands List", path: "/attributes/brand/list", pro: false },
          { name: "Add Brand", path: "/attributes/brand/add", pro: false },
        ],
      },
      {
        name: "Delivery Options",
        path: "/attributes/delivery-options",
        subItems: [
          {
  ...
  //         {
  //           name: "View Stock",
  //           path: "/inventory/stock-levels/view",
  //           pro: false,
  //         },
  //         {
  //           name: "Update Stock",
  //           path: "/inventory/stock-levels/update",
  //           pro: false,
  //         },
  //       ],
  //     },
  ...
  //           path: "/inventory/low-stock/configure",
  //           pro: false,
  //         },
  //       ],
  //     },
  ...
  //           path: "/inventory/adjustments/list",
  //           pro: false,
  //         },
  //         {
  //           name: "Add Adjustment",
  //           path: "/inventory/adjustments/add",
  //           pro: false,
  //         },
  //       ],
  //     },
  ...
  //         {
  //           name: "Orders List",
  //           path: "/inventory/purchase-orders/list",
  //           pro: false,
  //         },
  //         {
  //           name: "Create Order",
...

  {
    ...
    subItems: [
      { name: "All Coupons", path: "/coupons/all", pro: false },
...

  {
    ...
    name: "Tax Management",
    subItems: [
      { name: "All Tax Classes", path: "/taxes/all", pro: false },
      { name: "Add Tax Class", path: "/taxes/add", pro: false },
      { name: "All Tax Class Option", path: "/taxes/options/all", pro: false },
      { name: "Add Tax Class Option", path: "/taxes/options/add", pro: false },
    ],
  },
        ...
        subItems: [
          {
            ...
            path: "/customers/reviews/products",
            pro: false,
          },
          {
            name: "Customer Feedback",
            path: "/customers/reviews/feedback",
            pro: false,
          },
        ],
      },
...

  {
    ...
    icon: <ListIcon />,
    subItems: [
      { name: "Add Category", path: "/blog/category/add", pro: false },
      { name: "Category List", path: "/blog/category/list", pro: false },
      { name: "Add Sub Category", path: "/blog/subcategory/add", pro: false },
      {
        name: "Sub Category List",
        path: "/blog/subcategory/list",
        pro: false,
      },
      { name: "Add Blog", path: "/blog/add", pro: false },
      { name: "Blog List", path: "/blog/list", pro: false },
    ],
  },
  {
    name: "FAQ Management",
