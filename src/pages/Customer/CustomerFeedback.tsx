...
const CustomerFeedback = () => {
  ...
  useEffect(() => {
    dispatch(fetchReviews({ page, limit, targetType: "website" }));
  }, [dispatch, page, limit]);

  // Filter by search input (by customer name or comment)
  const filteredFeedback = results.filter((r: any) =>
    [
  ...
  return (
    <div>
      <PageMeta title="Customer Feedback | TailAdmin" description="List of all customer feedback" />
      <PageBreadcrumb pageTitle="Customer Feedback" />
          ...
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead className="bg-gray-50 dark:bg-gray-800">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase dark:text-gray-400">Feedback</th>
            ...
            <tbody className="bg-white divide-y divide-gray-100 dark:bg-gray-900 dark:divide-gray-800">
              ...
              {filteredFeedback.map((r: any, idx: number) => (
                <tr key={r._id || idx} className="hover:bg-gray-50 dark:hover:bg-gray-800">
