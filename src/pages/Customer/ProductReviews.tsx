...
const ProductReviews = () => {
  ...
  useEffect(() => {
    dispatch(fetchReviews({ page, limit, targetType: "product" }));
  }, [dispatch, page, limit]);

  // Filter by search input (by product name, user name, or comment)
  const filteredReviews = results.filter((r: any) =>
    [
      r.product?.name,
  ...
  return (
    <div>
      <PageMeta title="Product Reviews | TailAdmin" description="List of all product reviews" />
          ...
          <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
            <thead className="bg-gray-50 dark:bg-gray-800">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase dark:text-gray-400">Comment</th>
