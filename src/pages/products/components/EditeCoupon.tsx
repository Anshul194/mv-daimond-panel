...
const UpdateCouponPage = () => {
  ...
  const couponId = params.id; // Assuming the URL is like /coupons/edit/:id
  ...
  useEffect(() => {
    // Simulate loading existing coupon data
    getData();
  }, []);
  ...
  const handleBack = () => {
    // Navigate back to coupon list
    console.log("Navigate back to coupon list");
  };
  ...
  return (
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900">Update Coupon</h1>
        ...
        {showSuccess && (
          <div className="mb-6 bg-green-50 border border-green-200 rounded-lg p-4 flex items-center">
            ...
            <span className="text-green-800">Coupon updated successfully!</span>
          </div>
        )}
